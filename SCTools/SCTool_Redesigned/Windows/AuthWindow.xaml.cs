...
namespace SCTool_Redesigned.Windows
{
    ...
    public partial class AuthWindow : Window
    {
        ...
        private async void CheckTGS()
        {
            ...
            var response = await HttpNetClient.Client.PostAsync(App.ApiServer + "/api/v4/patcher/mode", content);
        ...
        public async Task<int> TryAuthAsync(string passwd)
        {
            ...
            var content = new StringContent(json.ToString(), Encoding.UTF8, "application/json");
            var response = await HttpNetClient.Client.PostAsync(App.ApiServer + "/api/v4/patcher/token", content);
